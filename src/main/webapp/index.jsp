...
<form action="cadastroLocacao" method="POST">
    ...
    <div class="container-md">
        ...
        <p class="text-center fs-1">Formulário Locação </p>
        ...
        <div class="input-group mb-3">
          <span class="input-group-text" id="inputGroup-sizing-default2">Cpf ou CNPJ</span>
          <input type="text" name="cpfCnpj" class="form-control">
        </div>

        <div class="input-group mb-3">
          <span class="input-group-text" id="inputGroup-sizing-default3">Telefone</span>
          <input type="text" name="telefone" class="form-control">
        </div>

        <div class="input-group mb-3">
          <span class="input-group-text" id="inputGroup-sizing-default">Marca Veículo</span>
